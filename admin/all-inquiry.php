                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title col-2">All Inquiry</div>

                                    <!-- <a href="add-blogs.php" class="btn btn-primary col-1" style="margin-left: 600px;">Add</a> -->
                                </div>
                                <?php
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="delete-inquiry.php?id=<?php echo $row['id'];  ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
