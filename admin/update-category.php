            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = "UPDATE `category` SET `category`='$category' WHERE id='$sid';";
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12 mb-0">
                                                        ...
                                                        <input type="hidden" name="sid" value="<?php echo $row['id']; ?>" />
                                                            <input type="text" class="form-control" name="category" id="" value="<?php echo $row['category']; ?>" placeholder="Courses Name" required="">
                                                        </div>
                                                    </div>
