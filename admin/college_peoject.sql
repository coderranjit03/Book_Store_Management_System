...
INSERT INTO `courses` (`id`, `category`, `c_images`, `heading`, `own_name`, `short_name`, `code`, `duration_from`, `duration_to`, `validity_certificate`, `details`, `price`, `date`) VALUES
(2, '1', '65421dda285a6frame.jpg', 'ASDF', 'SUSHANT', '', '', '', '', 'ADF23', '<p>fsdhdfkj</p>', '567', '2023-11-01');
